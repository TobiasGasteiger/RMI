...
public class QuadratImpl implements Quadrat{
    ...
    public static void main(String[] args) {
        try {
            ...
            //Create the genericRemote Remote Object
            TaskImpl genericRemote = new TaskImpl();
            Task g_stub = (Task) UnicastRemoteObject.exportObject(genericRemote, 1);
            //Create the registry
            LocateRegistry.createRegistry(Registry.REGISTRY_PORT);
            // Register the remote object in RMI registry with a given identifier
            Registry registry = LocateRegistry.getRegistry();
            registry.bind("Quadrat1", q_stub);
            registry.bind("Generic1", g_stub);
